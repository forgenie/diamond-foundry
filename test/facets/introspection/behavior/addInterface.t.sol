...
import { Introspection_AlreadySupported } from "src/facets/introspection/IntrospectionBehavior.sol";
...
contract IntrospectionBase_addInterface is IntrospectionBaseTest {
    function test_RevertsWhen_AlreadySupported() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Introspection_AlreadySupported.selector));
